...
class TestIsVideoFile:
    ...
    def test_common_video_extensions(self):
        ...
        for filename in video_files:
            assert (
                is_video_file(filename) is True
            ), f"{filename} should be detected as video"
    ...
    def test_non_video_extensions(self):
        ...
        for filename in non_video_files:
            assert (
                is_video_file(filename) is False
            ), f"{filename} should not be detected as video"
...
class TestIsAudioFile:
    ...
    def test_common_audio_extensions(self):
        ...
        for filename in audio_files:
            assert (
                is_audio_file(filename) is True
            ), f"{filename} should be detected as audio"
    ...
    def test_non_audio_extensions(self):
        ...
        for filename in non_audio_files:
            assert (
                is_audio_file(filename) is False
            ), f"{filename} should not be detected as audio"
