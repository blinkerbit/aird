...
class TestAdminHandler:
    ...
    def test_get_not_admin_user_redirects(self, mock_tornado_app, mock_tornado_request):
        ...
        ), patch.object(handler, "is_admin_user", return_value=False), patch.object(
            handler, "redirect"
        ) as mock_redirect:
    ...
    def test_get_admin_user_with_db_connection(
        ...
        with patch.object(
            ...
            "aird.handlers.admin_handlers.FEATURE_FLAGS",
            {"file_upload": True, "file_delete": False},
        ), patch(
            "aird.db.load_feature_flags",
            return_value={"file_upload": True, "file_delete": False},
        ), patch(
            "aird.utils.util.get_current_websocket_config",
            return_value={"max_connections": 50},
        ), patch.object(
            handler, "render"
        ) as mock_render:
    ...
    def test_get_admin_user_without_db_connection(
    ...
    def test_post_not_admin_user_returns_403(
        self, mock_tornado_app, mock_tornado_request
    ):
    ...
    def test_post_admin_user_updates_feature_flags(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        ...
        handler.get_argument = MagicMock(
            side_effect=lambda key, default="off": {
                "file_upload": "on",
                "file_delete": "off",
                "file_rename": "on",
                "file_download": "off",
        ...
        with patch.object(
            ...
            "aird.handlers.admin_handlers.FEATURE_FLAGS", feature_flags
        ), patch(
    ...
    def test_post_updates_websocket_config_with_limits(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
    ...
    def test_post_handles_invalid_websocket_config(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
    ...
    def test_post_handles_db_error_gracefully(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
...
class TestAdminHandlerUploadConfig:
    ...
    def test_get_passes_upload_config_to_template(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        ...
        with patch.object(
            ...
            "aird.handlers.admin_handlers.FEATURE_FLAGS", {"file_upload": True}
        ), patch(
    ...
    def test_post_updates_max_file_size(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
    ...
    def test_post_handles_invalid_max_file_size(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
    ...
    def test_post_updates_constants_max_file_size(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
...
class TestWebSocketStatsHandler:
    ...
    def test_get_not_admin_user_returns_403(
        self, mock_tornado_app, mock_tornado_request
    ):
    ...
    def test_get_admin_user_returns_stats(self, mock_tornado_app, mock_tornado_request):
        ...
        with patch.object(
            ...
            "aird.handlers.admin_handlers.FeatureFlagSocketHandler"
        ) as mock_feature_handler, patch(
            "aird.handlers.admin_handlers.FileStreamHandler"
        ) as mock_stream_handler, patch(
            "aird.handlers.admin_handlers.SuperSearchWebSocketHandler"
        ) as mock_search_handler, patch.object(
            handler, "set_header"
        ) as mock_set_header, patch.object(
            handler, "write"
        ) as mock_write:
...
class TestAdminUsersHandler:
    ...
    def test_get_renders_users_when_db_available(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = AdminUsersHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_get_renders_empty_when_db_missing(
        self, mock_tornado_app, mock_tornado_request
    ):
        handler = AdminUsersHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
...
class TestUserCreateHandler:
    def test_get_not_admin_returns_403(self, mock_tornado_app, mock_tornado_request):
        ...
        with patch.object(handler, "is_admin_user", return_value=False), patch.object(
            handler, "set_status"
        ) as mock_status, patch.object(handler, "write") as mock_write:
            handler.get()
    ...
    def test_get_admin_renders_form(self, mock_tornado_app, mock_tornado_request):
        handler = UserCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
        with patch.object(handler, "is_admin_user", return_value=True), patch.object(
            handler, "render"
        ) as mock_render:
            handler.get()
            mock_render.assert_called_once_with("user_create.html", error=None)

    def test_post_renders_error_when_db_missing(
        self, mock_tornado_app, mock_tornado_request
    ):
        handler = UserCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_missing_username(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_short_password_rejected(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            mock_render.assert_called_once()
            assert (
                mock_render.call_args.kwargs["error"]
                == "Password must be at least 12 characters long."
            )

    def test_post_invalid_role(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_invalid_username_characters(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_handles_create_user_value_error(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_handles_create_user_exception(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
...
class TestUserEditHandler:
    def test_get_returns_404_when_user_missing(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
    ...
    def test_get_returns_500_when_db_missing(
        self, mock_tornado_app, mock_tornado_request
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_get_invalid_user_id_returns_400(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_returns_500_when_db_missing(
        self, mock_tornado_app, mock_tornado_request
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_user_not_found_returns_404(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_invalid_username_renders_error(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_short_password_renders_error(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_invalid_role_renders_error(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_invalid_username_characters_renders_error(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_password_change_blocked_when_ldap_enabled(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            assert (
                ...
                in mock_render.call_args.kwargs["error"]
            )

    def test_post_update_user_failure_renders_error(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_invalid_user_id_returns_400(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_handles_exception(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
...
class TestUserDeleteHandler:
    def test_post_invalid_id_returns_400(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
    ...
    def test_post_delete_user_returns_false(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserDeleteHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_invalid_user_id_value_error(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = UserDeleteHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
...
class TestLDAPConfigHandler:
    ...
    def test_get_renders_configs(
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            "aird.handlers.admin_handlers.get_all_ldap_configs", return_value=configs
        ), patch(
            "aird.handlers.admin_handlers.get_ldap_sync_logs", return_value=logs
        ), patch.object(
            handler, "render"
        ) as mock_render:
            handler.get()
            mock_render.assert_called_once_with(
                "admin_ldap.html", configs=configs, sync_logs=logs
            )
    ...
    def test_get_handles_missing_db(self, mock_tornado_app, mock_tornado_request):
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            handler.get()
            mock_render.assert_called_once_with(
                "admin_ldap.html", configs=[], sync_logs=[]
            )
...
class TestLDAPConfigCreateHandler:
    def test_post_missing_db_renders_error(
        self, mock_tornado_app, mock_tornado_request
    ):
    ...
    def test_post_creates_configuration(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = LDAPConfigCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            "aird.handlers.admin_handlers.create_ldap_config"
    ...
    def test_post_invalid_name_length(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = LDAPConfigCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            assert (
                mock_render.call_args.kwargs["error"]
                == "Configuration name must be between 3 and 50 characters"
            )

    def test_post_handles_value_error(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = LDAPConfigCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_handles_general_exception(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = LDAPConfigCreateHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            handler.post()
            assert (
                "Error creating configuration" in mock_render.call_args.kwargs["error"]
            )
...
class TestLDAPConfigEditHandler:
    def test_get_returns_404_when_missing(
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            "aird.handlers.admin_handlers.get_ldap_config_by_id", return_value=None
        ), patch.object(
            handler, "set_status"
        ) as mock_status, patch.object(
            handler, "write"
    ...
    def test_post_updates_configuration(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = LDAPConfigEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            "aird.handlers.admin_handlers.get_ldap_config_by_id", return_value=config
        ), patch(
            "aird.handlers.admin_handlers.update_ldap_config", return_value=True
        ) as mock_update_config, patch.object(
            handler, "redirect"
        ) as mock_redirect:
            handler.post("1")
    ...
    def test_get_invalid_id_returns_error(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = LDAPConfigEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_returns_404_when_config_missing(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = LDAPConfigEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_invalid_name_length(
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            handler.post("1")
            assert (
                "between 3 and 50 characters" in mock_render.call_args.kwargs["error"]
            )

    def test_post_update_failure_renders_error(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = LDAPConfigEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            "aird.handlers.admin_handlers.update_ldap_config", return_value=False
        ), patch.object(
            handler, "render"
        ) as mock_render:
            handler.post("1")
    ...
    def test_post_invalid_config_id_value_error(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = LDAPConfigEditHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
    ...
    def test_post_handles_exception(
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            "aird.handlers.admin_handlers.update_ldap_config",
            side_effect=Exception("boom"),
        ), patch.object(
            handler, "render"
        ) as mock_render:
            handler.post("1")
            assert (
                "Error updating configuration" in mock_render.call_args.kwargs["error"]
            )
...
class TestLDAPConfigDeleteHandler:
    ...
    def test_post_deletes_config(
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            "aird.handlers.admin_handlers.delete_ldap_config", return_value=True
    ...
    def test_post_delete_returns_false(
        self, mock_tornado_app, mock_tornado_request, mock_db_conn
    ):
        handler = LDAPConfigDeleteHandler(mock_tornado_app, mock_tornado_request)
        authenticate(handler)
        ...
        with patch.object(handler, "is_admin_user", return_value=True), patch_db_conn(
            ...
            "aird.handlers.admin_handlers.delete_ldap_config", return_value=False
        ), patch.object(
            handler, "set_status"
        ) as mock_status, patch.object(
            handler, "write"
